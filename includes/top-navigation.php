                    ...
                    <div class="container-fluid px-0">
                        ...
                        <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                            <ul class="navbar-nav navbar-nav-hover ms-auto">
                                ...
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" href="../membre/s'inscrire.php" aria-expanded="false">
                                        <i class="material-icons opacity-6 me-2 text-md">admin_panel_settings</i> S'inscrire
                                    </a>
                                </li>
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" href="./membre" aria-expanded="false">
                                        <i class="material-icons opacity-6 me-2 text-md">admin_panel_settings</i> membre Login
                                    </a>
                                </li>
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" href="./club_admin" aria-expanded="false">
                                        <i class="material-icons opacity-6 me-2 text-md">person</i> Club president Login
                                    </a>
                                </li>
                            </ul>
                        </div>
