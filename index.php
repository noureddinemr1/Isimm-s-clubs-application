...
<body class="index-page bg-gray-200">
    ...
    <a href="./?page=clubs/application_form&id=<?= isset($id) ? $id : '' ?>" class="btn btn-primary btn-sm" style="fit-content:auto;"><span class="material-icons" >text_snippet</span> s'inscrire</a>
